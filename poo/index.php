...
{
    echo '<p>le numero de CB du client est valide</p>';
}
...
// Visiblite des membre d'une classe  en POO
    $alban = new Client('CARROLE', 'alban', '1454444445555222');
    echo '<br>' . $alban->nom .' '. $alban->getNbCb();

    $alban->setNbCb('1111111111111111');// mis à jour on effectué car valeu passée en entré
    //ne correspont pas aux criteres de validation (longeur de 16) imposé par
    //la methode privée(isNbCbOk()) utilisé en inerne par le setteur setNbCb();
    echo '<br>' . $alban->nom .' '. $alban->getNbCb();
